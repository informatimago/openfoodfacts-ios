...
class IngredientsHeaderCellControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        viewController = IngredientsHeaderCellController(with: Product(), dataManager: dataManager)
    ...
    func testViewDidLoadWhenProductHasImageUrl() {
        ...
        //PJB expect(self.viewController.addNewPictureButton.isHidden).to(beFalse())
    }
    ...
    func testViewDidLoadWhenProductDoesNotHaveImageUrl() {
        ...
        //PJB expect(self.viewController.addNewPictureButton.isHidden).to(beTrue())
    }
